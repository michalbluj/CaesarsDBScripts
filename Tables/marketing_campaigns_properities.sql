CREATE TABLE caesars.marketing_campaigns_properties (
  id				BIGSERIAL,
  i_dmid                        varchar(11),
  ...
  c_gst_pref_mail_flag          varchar(1),
  ...
  c_prop_cd                     varchar(3),
  f_property_worth              numeric,
  d_last_activity_dt_prop       date,
  c_property_frequency          varchar(20),
  ...
  c_credit_suppress_flag_m_ah   varchar(3),
  d_last_rated_dt_mkt_ah        date,
  contact			varchar(18)
) WITH OIDS;
 ALTER TABLE caesars.marketing_campaigns_properties ADD PRIMARY KEY (id);

 CREATE INDEX contact_mcp_idx ON caesars.marketing_campaigns_properties (contact);
 CREATE INDEX idmid_mcp_idx ON caesars.marketing_campaigns_properties (i_dmid);